...
options.replace=true;jQuery(options.blockSelector,context).each(function(){jQuery(this).syntax(jQuery.extend({},options,{brush:Syntax.extractBrushName(this.className),layout:options.blockLayout}),callback);});jQuery(options.inlineSelector,context).each(function(){jQuery(this).syntax(jQuery.extend({},options,{brush:Syntax.extractBrushName(this.className),layout:options.inlineLayout}),callback);});};Syntax.alias("basic",['vb']);Syntax.alias("css",[]);Syntax.alias("diff",["patch"]);Syntax.alias("go",[]);Syntax.alias("html",[]);Syntax.alias("javascript",["js","actionscript"]);Syntax.alias("pascal",["delphi"]);Syntax.alias("php-script",[]);Syntax.alias("php",[]);Syntax.alias("plain",["text"]);Syntax.alias("python",[]);Syntax.alias("scala",[]);Syntax.alias("sql",[]);Syntax.alias("xml",[]);Syntax.styles["jquery.syntax.brush.css"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.brush.css.css"];Syntax.styles["jquery.syntax.brush.diff"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.brush.diff.css"];Syntax.styles["jquery.syntax.brush.html"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.brush.html.css"];Syntax.styles["jquery.syntax.brush.python"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.brush.python.css"];Syntax.styles["jquery.syntax.brush.xml"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.brush.xml.css"];Syntax.styles["jquery.syntax.core"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.core.css","../../../css/libs/jquery.syntax/bright/jquery.syntax.core.css","../../../css/libs/jquery.syntax/paper/jquery.syntax.core.css"];Syntax.styles["jquery.syntax.layout.editor"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.layout.editor.css","../../../css/libs/jquery.syntax/grey/jquery.syntax.layout.editor.css","../../../css/libs/jquery.syntax/modern/jquery.syntax.layout.editor.css"];Syntax.styles["jquery.syntax.layout.fixed"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.layout.fixed.css","../../../css/libs/jquery.syntax/grey/jquery.syntax.layout.fixed.css","../../../css/libs/jquery.syntax/modern/jquery.syntax.layout.fixed.css","../../../css/libs/jquery.syntax/paper/jquery.syntax.layout.fixed.css"];Syntax.styles["jquery.syntax.layout.list"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.layout.list.css","../../../css/libs/jquery.syntax/grey/jquery.syntax.layout.list.css"];Syntax.styles["jquery.syntax.layout.plain"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.layout.plain.css","../../../css/libs/jquery.syntax/grey/jquery.syntax.layout.plain.css","../../../css/libs/jquery.syntax/modern/jquery.syntax.layout.plain.css"];Syntax.styles["jquery.syntax.layout.table"]=["../../../css/libs/jquery.syntax/base/jquery.syntax.layout.table.css","../../../css/libs/jquery.syntax/grey/jquery.syntax.layout.table.css"];Syntax.styles["jquery.syntax.layout.inline"]=["../../../css/libs/jquery.syntax/grey/jquery.syntax.layout.inline.css","../../../css/libs/jquery.syntax/modern/jquery.syntax.layout.inline.css","../../../css/libs/jquery.syntax/paper/jquery.syntax.layout.inline.css"];Syntax.themes["base"]=[]
